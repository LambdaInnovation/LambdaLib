...
/**
 * A helper class used to find objects (functions and values) from a
 * ScriptProgram.
 * 
 * @author acaly
 *
...
public final class ScriptNamespace {
    ...
    /**
     * Get the namespace under this namespace. Note that this function never
     * check the parent namespace, as a namespace always exists.
     * 
     * @param path
     * @return
     */
