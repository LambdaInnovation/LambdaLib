...
/**
 * The global object of a ripple program. It contains all functions and values,
 * and handles script file parsing.
 * 
...
public final class ScriptProgram {
	...
	/**
	 * Loads a script from the given reader. The fileName is just used for debug
	 * output.
	 */
